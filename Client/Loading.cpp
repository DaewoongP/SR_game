...
_uint CLoading::Loading_ForLogo(void)
{
	...
	FAILED_CHECK_RETURN(Engine::Ready_Proto(L"Final_Cube", CTexture::Create(m_pGraphicDev, TEX_CUBE, L"../Resource/Texture/SkyBox/FinalChapter/Final%d.dds", 24)), E_FAIL);
