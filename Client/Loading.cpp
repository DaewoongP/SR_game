...
_uint CLoading::Loading_ForLogo(void)
{
	...
	// 아이템 관련(인디게임레전드 리소스)
	FAILED_CHECK_RETURN(Engine::Ready_Proto(L"Item_Texture", CTexture::Create(m_pGraphicDev, TEX_NORMAL, L"../Resource/Texture/Item/Item%d.png", 4)), E_FAIL);
	...
	FAILED_CHECK_RETURN(Engine::Ready_Proto(L"ShootingLaser", CTexture::Create(m_pGraphicDev, TEX_NORMAL, L"../Resource/Texture/Export_Textures/Sprites/ShootingLaser/shootingLaserSpr_%d.png", 36)), E_FAIL);
	// Laser
	...
	FAILED_CHECK_RETURN(Engine::Ready_Proto(L"PigCube", CTexture::Create(m_pGraphicDev, TEX_CUBE, L"../Resource/Texture/SkyBox/PigCube.dds")), E_FAIL);
	...
	FAILED_CHECK_RETURN(Engine::Ready_Proto(L"Stage_Cube", CTexture::Create(m_pGraphicDev, TEX_CUBE, L"../Resource/Texture/SkyBox/Stage_%d.dds", 9)), E_FAIL);
