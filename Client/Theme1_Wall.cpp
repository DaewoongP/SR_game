...
CTheme1_Wall * CTheme1_Wall::Create(LPDIRECT3DDEVICE9 pGraphicDev, _vec3 & vPos, _float fScale, _float fAngle)
{
...
HRESULT CTheme1_Wall::Ready_GameObject(_vec3 & vPos, _float fScale, _float fAngle)
{
