...
//?ÑÏû¨ ?§ÌÖå?¥Ìä∏Í∞Ä Í∞ôÏ?Í≤??ÑÎãà?ºÎ©¥ true Î∞?Î≥ÄÍ≤?
void CBoss2::SetPartten()
{
	//100 ?àÏ™Ω???úÎç§ ?úÏàò ?ùÏÑ±
	int ranIdx = 0;
