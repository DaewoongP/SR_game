...
CTheme2_PigStatue_1 * CTheme2_PigStatue_1::Create(LPDIRECT3DDEVICE9 pGraphicDev, _vec3 & vPos, _float fScale)
{
...
HRESULT CTheme2_PigStatue_1::Ready_GameObject(_vec3 & vPos, _float fScale)
{
