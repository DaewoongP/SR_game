...
CTheme1_Cow::CTheme1_Cow(LPDIRECT3DDEVICE9 pGraphicDev)
	:
	CBackGroundBase(pGraphicDev)
{
}

CTheme1_Cow::~CTheme1_Cow()
{
}

_int CTheme1_Cow::Update_GameObject(const _float& fTimeDelta)
{
...
_int CTheme1_Cow::Update_Too(const _float& fTimeDelta)
{
...
void CTheme1_Cow::Render_GameObject(void)
{
...
CTheme1_Cow* CTheme1_Cow::Create(LPDIRECT3DDEVICE9 pGraphicDev, _vec3& vPos, _float fScale, _float fAngle)
{
	CTheme1_Cow* pInstance = new CTheme1_Cow(pGraphicDev);
...
HRESULT CTheme1_Cow::Ready_GameObject(_vec3& vPos, _float fScale, _float fAngle)
{
...
HRESULT CTheme1_Cow::Add_Component(void)
{
	...
	pComponent = m_pTextureCom = dynamic_cast<CTexture*>(Engine::Clone_Proto(L"T1Cow", this));
	NULL_CHECK_RETURN(m_pTextureCom, E_FAIL);
	m_vecComponent[ID_STATIC].push_back({ L"T1Cow", pComponent });

	return S_OK;
}

void CTheme1_Cow::Free(void)
{
	__super::Free();
}