...
HRESULT CStage1::Ready_Layer_GameLogic(const _tchar * pLayerTag)
{
	...
	CGameObject*		pGameObject = nullptr;
	FAILED_CHECK_RETURN(FACTORY<CPig>::Create(L"Pig", pLayer, _vec3(60.f, 7.f, 10.f)), E_FAIL);
	FAILED_CHECK_RETURN(FACTORY<CPig>::Create(L"Pig", pLayer, _vec3(50.f, 7.f, 10.f)), E_FAIL);
	FAILED_CHECK_RETURN(FACTORY<CPig>::Create(L"Pig", pLayer, _vec3(40.f, 7.f, 10.f)), E_FAIL);
	FAILED_CHECK_RETURN(FACTORY<CPig>::Create(L"Pig", pLayer, _vec3(30.f, 20.f, 10.f)), E_FAIL);
	FAILED_CHECK_RETURN(FACTORY<CPig>::Create(L"Pig", pLayer, _vec3(30.f, 7.f, 10.f)), E_FAIL);
	FAILED_CHECK_RETURN(FACTORY<CPig>::Create(L"Pig", pLayer, _vec3(20.f, 7.f, 10.f)), E_FAIL);
	FAILED_CHECK_RETURN(FACTORY<CPig>::Create(L"Pig", pLayer, _vec3(10.f, 7.f, 10.f)), E_FAIL);
	FAILED_CHECK_RETURN(FACTORY<CBat>::Create(L"Bat", pLayer, _vec3(60.f, 7.f, 10.f)), E_FAIL);
	FAILED_CHECK_RETURN(FACTORY<CBat>::Create(L"Bat", pLayer, _vec3(50.f, 7.f, 10.f)), E_FAIL);
	FAILED_CHECK_RETURN(FACTORY<CBat>::Create(L"Bat", pLayer, _vec3(40.f, 7.f, 10.f)), E_FAIL);
	FAILED_CHECK_RETURN(FACTORY<CBat>::Create(L"Bat", pLayer, _vec3(30.f, 20.f, 10.f)), E_FAIL);
	FAILED_CHECK_RETURN(FACTORY<CBat>::Create(L"Bat", pLayer, _vec3(30.f, 7.f, 10.f)), E_FAIL);
	FAILED_CHECK_RETURN(FACTORY<CBat>::Create(L"Bat", pLayer, _vec3(20.f, 7.f, 10.f)), E_FAIL);
	FAILED_CHECK_RETURN(FACTORY<CBat>::Create(L"Bat", pLayer, _vec3(10.f, 7.f, 10.f)), E_FAIL);
	...
	FAILED_CHECK_RETURN(FACTORY<CSwitch>::Create(L"Switch", pLayer, _vec3(10.f, 7.f, 10.f)), E_FAIL);
