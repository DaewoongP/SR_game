...
HRESULT CStage1::Ready_Layer_GameLogic(const _tchar * pLayerTag)
{
	...
	FAILED_CHECK_RETURN(FACTORY<CPig>::Create(L"Pig", pLayer, _vec3(50.f, 9.f, 10.f)), E_FAIL);
	...
	FAILED_CHECK_RETURN(FACTORY<CGravityCube>::Create(L"GravityCube", pLayer, _vec3(10.f, 10.f, 10.f)), E_FAIL);
	FAILED_CHECK_RETURN(FACTORY<CGravityCube>::Create(L"GravityCube", pLayer, _vec3(12.f, 10.f, 10.f)), E_FAIL);
	FAILED_CHECK_RETURN(FACTORY<CGravityCube>::Create(L"GravityCube", pLayer, _vec3(14.f, 10.f, 10.f)), E_FAIL);
